...
_This is the third in a series of worksheets for HIST 446 at Ball State University. The goal of these worksheets is simple: practice, practice, practice. The worksheet introduces concepts and techniques and includes prompts for you to practice in this interactive document. When you are finished, you should change the author name (above), commit your changes, and push to GitHub. Don't forget to commit your changes as you go -- you should make multiple commits as you work through the worksheet, not just one at the end. Lastly, remember to fill out a weekly learning log in the `logs/` folder of your repository as you work through the assignment. Submit a copy of your log to Canvas._
...
The basic format is this. (Note that this is a sketch of the syntax, not runnable code -- `condition`, `true_action`, and `false_action` are placeholders for you to fill in.)
```
...
The first example above works. Why? Because 2 is indeed less than 3. The second line has no output. Why? Because the conditions weren't met. 3 is not less than 2 and so it didn't print anything out.
...
(@) You are teaching Social Studies at a High School in Muncie, Indiana. Your class has an enrollment cap of 30 students. Write an `if` statement that calculates whether the enrollment cap has been met. 
```{r}
...
What does this loop do? `1:3` is shorthand for 1, 2, 3. Run it in your console to see its output. This code says, for every number in the range 1:3, print the number.
...
(@) Create a character vector that contains the title of each of your classes this semester. Can you write a `for` loop that prints out "I am enrolled in" and the name of each of your classes? ("I am enrolled in History 200", "I am enrolled in History 446".....etc). 
...
**Hint 1:** Create a counter to track how many you've found.
**Hint 2:** The city appears in the data as 'New York City'.
```{r}
...
(@) Write a function called `count_by_state()` that:
   - Takes a state abbreviation as an argument (like "IN" or "CA")
