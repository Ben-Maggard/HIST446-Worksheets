...
> When i ran the code it put the words together. 
...
>The code on each line is a comparison that will equal either true or false.
...
>The code above multiple values where put into one vector. 
...
>I learned vectors and the way they worked. 
